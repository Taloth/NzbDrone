...
namespace NzbDrone.Core.Test.MediaFiles
{
    ...
    public class DownloadedEpisodesImportServiceFixture : CoreTest<DownloadedEpisodesImportService>
    {
        ...
        public void Setup()
        {
            Mocker.GetMock<IDiskScanService>().Setup(c => c.GetFileSets(It.IsAny<string>(), It.IsAny<bool>()))
                  .Returns(_videoFiles.Select(c => new FileSet(c)).ToArray());
            ...
            Mocker.GetMock<IConfigService>().SetupGet(c => c.DownloadClientWorkingFolders)
        ...
        public void should_skip_if_no_series_found()
        {
            ...
            Mocker.GetMock<IMakeImportDecision>()
                .Verify(c => c.GetImportDecisions(It.IsAny<List<FileSet>>(), It.IsAny<Series>(), It.IsAny<bool>(), It.IsAny<Core.Qualities.QualityModel>()),
                    Times.Never());
        ...
        public void should_not_import_if_folder_is_a_series_path()
        {
            ...
            Mocker.GetMock<IDiskScanService>()
                  .Setup(c => c.GetFileSets(It.IsAny<string>(), It.IsAny<bool>()))
                  .Returns(new FileSet[0]);
        ...
        public void should_not_delete_folder_if_files_were_imported_and_video_files_remain()
        {
            ...
            Mocker.GetMock<IMakeImportDecision>()
                  .Setup(s => s.GetImportDecisions(It.IsAny<List<FileSet>>(), It.IsAny<Series>(), true, null))
                  .Returns(imported);
